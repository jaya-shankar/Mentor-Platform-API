...
class get_course_info_view(generics.ListAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        return error_404(message="Only Creator can update course details ", status=)
...
class get_messages_view(generics.ListAPIView):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if(course.creator!=request.user):
            return error_404(message="Only creator of the groups can post message",status=status.HTTP_403_FORBIDDEN)
